...
export type SubmitActionFn = (prev: SubmitActionState, formData: FormData) => Promise<SubmitActionState>
...
export function SubmissionForm({
  ...
  const [state, formAction, pending] = useActionState<SubmitActionState, FormData>(
    onSubmitAction,
    undefined,
  )
